      ...
      {showWithdrawModal && (
        <ModalOverlay onClose={() => setShowWithdrawModal(false)}>
          ...
          <form onSubmit={handleWithdraw} className="space-y-4">
            <div>
              <label className="block text-xs font-semibold text-gray-600 mb-1">Jumlah Penarikan (Rp)</label>
              <input
                type="number"
                required
                min={10000}
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-600 mb-1">Nama Bank / E-Wallet</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-600 mb-1">Nomor Rekening / No. HP</label>
              <input
                type="text"
                required
            ...
            <div>
              <label className="block text-xs font-semibold text-gray-600 mb-1">Atas Nama</label>
              <input
                type="text"
                required
